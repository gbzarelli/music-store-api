package br.com.helpdev.musicstore.spotify;
...
public class SpotifyAPI {
    ...
    SpotifyAPI(@Value(ResourceConst.KEY_SPOTIFY_CLIENT_ID) final String clientId,
               @Value(ResourceConst.KEY_SPOTIFY_CLIENT_SECRET) final String clientSecret
    ) {
